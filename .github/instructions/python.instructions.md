...
1. **Choose tooling:** uv OR traditional pip/venv (remove unused section)
2. **Set Python version:** Update examples for your target Python version (3.9, 3.10, 3.12, 3.14)
3. **Framework specifics:** Add sections for Flask, FastAPI, Django, etc. if applicable
4. **Project patterns:** Add your specific architectural patterns (CQRS, DDD, etc.)
5. **Quality gates:** Specify which tools are mandatory vs. optional
6. **Testing requirements:** Define coverage thresholds and testing standards

**Source:** Consolidated from agent-spike, mentat-cli, joyride-python, attempt-one, onboard
